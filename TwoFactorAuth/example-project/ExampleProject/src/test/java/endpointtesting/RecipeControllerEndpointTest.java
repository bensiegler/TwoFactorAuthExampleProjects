...
public class RecipeControllerEndpointTest {
    ...
    public void testGetRecipesByNameSuccessBehavior() throws Exception {
        ...
        assertThat(returnedRecipes.length == 3);
        ...
        assertThat(returnedRecipes.length == 1);

        //make sure the recipe isn't null
        assertThat(null != returnedRecipes[0]);
    ...
    public void testGetRecipeByNameFailureBehavior() throws Exception {
        ...
        //convert json to String. Since this is not actually json but plain text you can use Arrays.toString()
        String message = Arrays.toString(contentAsByteArray);

        //confirm error message is correct
        assertThat(message.equals("No recipes could be found with that name"));
    }
    ...
    public void testUpdateRecipeSuccessBehavior() throws Exception {
        ...
        recipeToUpdate.setMinutesToMake(2);
        ...
        Recipe returnedUpdatedRecipe = reader.readValue(updateResponseByteArr);

        assertThat(returnedUpdatedRecipe.equals(recipeToUpdate));
    ...
    public void testDeleteRecipeByIdSuccessBehavior() throws Exception {
        ...
        String returnedDeleteConfirmationMessage = Arrays.toString(deleteResponseByteArr);
        ...
        assertThat(returnedDeleteConfirmationMessage
                .equals("The recipe with ID"  + recipe3.getId() + " and name " + recipe3.getName() + " was deleted"));
    }
